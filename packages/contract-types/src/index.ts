 ...
 */
export type MultiPayloadNarrowed =
	| {
			standard: "nep413";
 ...
 */
export interface Nep413Payload__Parsed {
	callbackUrl?: string | null;
	message: {
		original: string;
 ...
 */
export interface MultiPayloadNep413__Parsed {
	payload: Nep413Payload__Parsed;
	public_key: string;
	signature: string;
	standard: "nep413";
 ...
 */
export interface MultiPayloadErc191__Parsed {
	payload: {
		original: string;
		parsed: DefusePayloadFor_DefuseIntents;
	};
 ...
 */
export interface MultiPayloadTip191__Parsed {
	payload: {
		original: string;
		parsed: DefusePayloadFor_DefuseIntents;
	};
 ...
 */
export interface MultiPayloadRawEd25519__Parsed {
	payload: {
		original: string;
		parsed: DefusePayloadFor_DefuseIntents;
	};
 ...
 */
export interface MultiPayloadTonConnect__Parsed {
	/**
	 * Wallet address in either [Raw](https://docs.ton.org/v3/documentation/smart-contracts/addresses/address-formats#raw-address) representation or [user-friendly](https://docs.ton.org/v3/documentation/smart-contracts/addresses/address-formats#user-friendly-address) format
	 */
	address: string;
 ...
 */
export interface MultiPayloadSep53__Parsed {
	payload: {
		original: string;
		parsed: DefusePayloadFor_DefuseIntents;
	};
