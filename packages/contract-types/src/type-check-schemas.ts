...
export const MultiPayloadWebauthnEd25519Schema: JSONSchemaType<Types.MultiPayloadWebauthnEd25519> =
	{
		type: "object",
		required: [
			"authenticator_data",
...
export const MultiPayloadWebauthnP256Schema: JSONSchemaType<Types.MultiPayloadWebauthnP256> =
	{
		type: "object",
		required: [
			"authenticator_data",
