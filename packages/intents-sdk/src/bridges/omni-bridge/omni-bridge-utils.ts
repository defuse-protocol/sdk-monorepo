...
import { ChainKind, omniAddress, isBridgeToken, calculateStorageAccountId } from "omni-bridge-sdk";
...
export function createWithdrawIntentsPrimitive(params: {
	...
	// 		recipient,
	// 		fee: "0",
	// 		native_token_fee: params.fee.toString(),
	// 	}),
	// }];
	return [{
		intent: "ft_withdraw",
