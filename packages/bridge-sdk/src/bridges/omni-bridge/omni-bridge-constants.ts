...
//@ts-ignore
export const supportedNetworks: Record<CAIP2_NETWORK, 'eth' | 'base' | 'arb' | 'btc' | 'sol'> = {
  [CAIP2_NETWORK.Ethereum]: "eth",
  [CAIP2_NETWORK.Base]: "base",
  [CAIP2_NETWORK.Arbitrum]: "arb",
  [CAIP2_NETWORK.Bitcoin]: "btc",
  [CAIP2_NETWORK.Solana]: "sol",
};
